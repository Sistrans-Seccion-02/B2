...
public class ProductoController {
    ...
    public String productoGuardar(@ModelAttribute Producto producto) {
        productoRepository.insertarProducto(producto.getNombre(), producto.getPrecio(), producto.getsMercado().getNombre(), producto.getTienda().getNombre(), producto.getComsumos_idConsumo().getIdConsumo());
    ...
    public String productoEditarGuardar(@PathVariable("nombre") String nombre, @ModelAttribute Producto producto) {
        productoRepository.actualizarProducto(nombre, producto.getPrecio(), producto.getsMercado().getNombre(), producto.getTienda().getNombre(), producto.getComsumos_idConsumo().getIdConsumo());
        return "redirect:/productos";
    }
