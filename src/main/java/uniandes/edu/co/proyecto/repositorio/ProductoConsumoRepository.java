...
public interface ProductoConsumoRepository extends JpaRepository<ProductoConsumo, Integer>{
    ...
    ProductoConsumo darProductoConsumo(@Param("idConsumo") Integer idConsumo, @Param("nombre") String nombre);

    @Modifying
    @Transactional
    @Query(value = "INSERT INTO productosConsumos (idConsumo, nombre) VALUES (:idConsumo, :nombre)", nativeQuery = true)
    void insertarProductoConsumo(@Param("idConsumo") Integer idConsumo, @Param("nombre") String nombre);
    ...
    void actualizarProductoConsumo(@Param("idConsumo") Integer idConsumo, @Param("nombre") String nombre);

    @Modifying
    @Transactional
    @Query(value = "DELETE FROM productosConsumos WHERE idConsumo = :idConsumo AND nombre = :nombre", nativeQuery = true)
    void eleminarProductoConsumo(@Param("idConsumo") Integer idConsumo, @Param("nombre") String nombre);
} 
