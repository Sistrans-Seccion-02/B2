...
public interface PlanConsumoRepository extends JpaRepository<PlanConsumo, Integer>{
    ...
    void insertarPlanConsumo(@Param("tipo") String tipo,@Param("descripcion") String descripcion, @Param("descuento") double descuento, @Param("descuentoBar") String descuentoBar, @Param("descuentoRestaurante") String descuentoRestaurante, @Param("descuentoSpa") String descuentoSpa, @Param("limiteBebidas") int limiteBebidas, @Param("descuentoLavado") String descuentoLavado);
